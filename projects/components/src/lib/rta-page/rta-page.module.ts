...
import { control } from './rta-page.control';
import { SviWindow } from "@sassoftware/vi-api";

@NgModule({
  imports: [CommonModule, FormsModule, RtaPageComponent],
  exports: [RtaPageComponent],
  providers: [
    {
      ...
      useFactory: (injector: Injector) => {
        return () => {
          customElements.define(
            ...
            createCustomElement(RtaPageComponent, { injector: injector })
          );
